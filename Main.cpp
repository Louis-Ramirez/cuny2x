...
GeniusBar genius_bar;
    ...
    cout << customer6.getName() << "'s wait time is still " ;//<< customer6.getWaitTime() <<" because there is no more
//space at the genius bar \n";                               ^commented this function because my compiler at this time cant handle this;
